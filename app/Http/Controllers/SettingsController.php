...
class SettingsController extends Controller
{
    private array $keys = [
        ...
        'allowed_break_minutes' => ['label' => 'Allowed break per day (mins)', 'description' => 'Break minutes not deducted from net hours. Only excess break time is deducted.', 'type' => 'number', 'step' => '5'],
